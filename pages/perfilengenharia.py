...
#######################################TRATAMENTO DE DADOS################################
df_engenharia = geral(df_engenharia)
df_engenharia_novo = geral(df_engenharia_novo)

###############################TRATAMENTO ESPECÍFICO#######################################
df_conclusao_eng = df_engenharia_novo.copy()
df_conclusao_eng = df_conclusao_eng[df_engenharia_novo.Situacao.isin(['formado'])]

df_conclusao_eng['Data_da_matricula'] = pd.to_datetime(df_conclusao_eng['Data_da_matricula'], format='%Y/%m/%d %H:%M:%S')
df_conclusao_eng['Data de conclusao'] = pd.to_datetime(df_conclusao_eng['Data de conclusao'], format='%Y/%m/%d %H:%M:%S')

df_conclusao_eng['Meses Conclusao'] = ((df_conclusao_eng['Data de conclusao'] - df_conclusao_eng['Data_da_matricula']).dt.days)/30
...
#Meses conclusão
colors = ['orange']
fig17 = px.histogram(df_conclusao_eng,x='Meses Conclusao',color_discrete_sequence=colors,title='Meses Conclusão - Engenharia da Computação')
